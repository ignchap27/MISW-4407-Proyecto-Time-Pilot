...
class PassedLevelScene(Scene):
    def do_create(self):
        ...
        create_text(self.ecs_world, "Level Passed", 35, yell, pygame.Vector2(250, 230), "center")
        create_text(self.ecs_world, "Press ESC for Main Menu", 14, yell,   pygame.Vector2(250,  290), "center")
